                ...
                <div class="col-12">
                    ...
                    <div class="invoice p-3 mb-3">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <h4>
                                    <img src="<?= BASE_URL . 'Common/assets/image/logo.png' ?>" alt="" width="120">
                        ...
                        <div class="row invoice-info">
                            ...
                            <div class="col-sm-4 invoice-col">
                                ...
                                <address>
                                    ...
                                    Tổng tiền: <?= formatPrice($donHang['tong_tien']) ?><br>
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($sanPhamDonHang as $key => $sanPham) : ?>
                                            <tr>
                                                <td><?= $key + 1 ?></td>
                                                <td><img src="<?= BASE_URL . $sanPham['hinh_anh'] ?>" alt="" width="100"></td>
                                                <td><?= $sanPham['ten_san_pham'] ?></td>
                                                <td><?= formatPrice($sanPham['don_gia']) ?></td>
                                                <td><?= $sanPham['so_luong'] ?></td>
                                                <td><?= formatPrice($sanPham['thanh_tien']) ?></td>
                                            </tr>
                                            <?php $tong_tien = $donHang['tong_tien']; ?>
                                        <?php endforeach ?>
